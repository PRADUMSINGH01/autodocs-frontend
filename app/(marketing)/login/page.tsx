    ...
    <div className="flex-1 flex flex-col justify-center items-center px-4 sm:px-6 lg:px-8 py-12 bg-[var(--color-background)] relative overflow-hidden">
      ...
      <div className="w-full max-w-md z-10">
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-[var(--color-muted)]">Sign in to manage your automated documentation</p>
        </div>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                ...
                <Link href="#" className="text-sm font-medium text-[var(--color-primary)] hover:text-[var(--color-accent)] transition-colors">
                  Forgot password?
                </Link>
              </div>
              <input
            ...
            <div>
              <button
                type="submit"
                className="flex w-full justify-center rounded-xl bg-[var(--color-primary)] px-4 py-3 text-sm font-bold text-[var(--color-background)] hover:bg-[var(--color-accent)] transition-all shadow-[0_0_15px_rgba(34,211,238,0.2)] hover:shadow-[0_0_25px_rgba(34,211,238,0.4)]"
              >
                Sign in
              </button>
            </div>
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="bg-[var(--color-surface)] px-4 text-[var(--color-muted)]">Or continue with</span>
              </div>
            </div>
        ...
        <p className="mt-8 text-center text-sm text-[var(--color-muted)]">
          ...
          <Link href="/signup" className="font-semibold text-[var(--color-primary)] hover:text-[var(--color-accent)] transition-colors">
            Sign up for free
          </Link>
        </p>
      </div>
